...
describe("EnvelopeFactory", function () {
  ...
  describe("create", function () {
    it("creates a generic event envelope", function () {
      ...
      expect(envelope.meta.correlationId).to.equal("message-id-1");
    ...
    it("factory-owned fields override caller-provided timestamp", function () {
      const factory = createFactory();
  ...
  it("user provided message id throws an explicit error", function () {
    const factory = createFactory();
    expect(() =>
      factory.create(
        {
    ...
    ).to.throw("Message id is generated by EnvelopeFactory");
  });
  ...
  describe("validation errors", function () {
    it("throws when meta is missing", function () {
      ...
      expect(() => factory.create()).to.throw(
        "Envelope meta must be a non-null object",
      );
    });
